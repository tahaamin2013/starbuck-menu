    ...
    items: [
      {
        ...
        link: "hello",
        sizes: [
          { size: "Tall 12 fl oz", calories: 15, price: "$2.95" },
          { size: "Short 8 fl oz", calories: 10, price: "$2.45" },
          { size: "Grande 16 fl oz", calories: 20, price: "$3.45" },
          { size: "Venti 20 fl oz", calories: 25, price: "$3.95" },
        ],
      },
    ],
  },
