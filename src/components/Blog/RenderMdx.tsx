...
const RenderMdx = ({ blog }: { blog: any }) => {
  ...
  return (
    <div
      className="text-prose font-in prose sm:prose-base md:prose-lg max-w-max prose-blockquote:bg-primary/20 prose-blockquote:p-2 prose-blockquote:px-6 prose-blockquote:border-primary prose-blockquote:not-italic prose-blockquote:rounded-r-lg !text-[16px] font-bold tracking-[1.7px] !text-zinc-500 prose-li:marker:text-primary "
