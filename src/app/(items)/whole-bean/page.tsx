...
// import { WholeBeans } from "../../../lib/menuItems"; // Adjust the path according to your directory structure
...
//               </BreadcrumbSeparator>
//               <BreadcrumbItem>
//                 <BreadcrumbLink href="/whole-bean ">
//                   Whole Bean
//                 </BreadcrumbLink>
//               </BreadcrumbItem>
//             </BreadcrumbList>
//           </Breadcrumb>
// <h1 className="mb-5 font-bold text-3xl">Whole Bean</h1>
//           {WholeBeans.map((category, index) => (
