...
import { HotTeas } from "../../../lib/menuItems"; // Adjust the path according to your directory structure
        ...
        <div className="ml-5 w-full">
          <Breadcrumb className="mb-3">
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink href="/hot-teas">Hot Teas</BreadcrumbLink>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          <h1 className="font-bold text-2xl">Hot Teas</h1>
          {HotTeas.map((category, index) => (
